...
class LaporanPerUserExport implements FromArray, WithStyles, WithTitle, WithColumnWidths
{
    protected $data;
    ...
    public function array(): array
    {
        $rows = [];
        $rows[] = []; // Spasi
        $rows[] = ['LAPORAN PENDAPATAN PER USER'];
        $rows[] = ['Periode: ' . Carbon::parse($this->tanggal)->isoFormat('MMMM YYYY')];

        $rows[] = []; // Spasi
        $rows[] = ['No', 'Nama User', 'Jumlah Transaksi', 'Total Pendapatan Bersih', 'Persentase'];
