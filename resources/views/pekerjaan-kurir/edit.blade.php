...
@section('title', 'Edit Pekerjaan Kurir')
...
<div class="content-header pb-2">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 h3 fw-bold text-dark">Edit Pekerjaan Kurir</h1>
            </div>
            <div class="col-sm-6">
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white border-bottom-0 pt-4 pb-0">
                        <h5 class="mb-0 fw-bold text-primary">
                            <i class="bi bi-truck me-2"></i>Form Edit Pekerjaan Kurir
                        </h5>
                    </div>

                    <div class="card-body p-4">
                        <form action="{{ route('pekerjaan-kurir.update', $PekerjaanKurir->id) }}" method="POST" enctype="multipart/form-data" id="FormPekerjaanKurir">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="date"
                                            ...
                                            id="Tanggal"
                                            name="Tanggal"
                                            value="{{ old('Tanggal', $PekerjaanKurir->Tanggal ?? date('Y-m-d')) }}"
                                            required>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="time"
                                            ...
                                            id="Jam"
                                            name="Jam"
                                            value="{{ old('Jam', $PekerjaanKurir->Jam ?? '') }}"
                                            required>
                                        <div class="form-text text-muted mt-1">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select
                                            ...
                                            name="Pekerjaan"
                                            required>
                                            <option value="" disabled {{ old('Pekerjaan', $PekerjaanKurir->Pekerjaan ?? '') ? '' : 'selected' }}>Pilih jenis pekerjaan</option>
                                            <option value="Ambil Paket" {{ old('Pekerjaan', $PekerjaanKurir->Pekerjaan ?? '') == 'Ambil Paket' ? 'selected' : '' }}>Ambil Paket</option>
                                            <option value="Antar Paket" {{ old('Pekerjaan', $PekerjaanKurir->Pekerjaan ?? '') == 'Antar Paket' ? 'selected' : '' }}>Antar Paket</option>
                                            <option value="Lain-lain" {{ old('Pekerjaan', $PekerjaanKurir->Pekerjaan ?? '') == 'Lain-lain' ? 'selected' : '' }}>Lain-lain</option>
                                        </select>
                                        <div class="form-text text-muted mt-1">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text"
                                            ...
                                            id="DariLokasi"
                                            name="DariLokasi"
                                            value="{{ old('DariLokasi', $PekerjaanKurir->DariLokasi ?? '') }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text"
                                            ...
                                            id="Tujuan"
                                            name="Tujuan"
                                            value="{{ old('Tujuan', $PekerjaanKurir->Tujuan ?? '') }}"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number"
                                            ...
                                            name="JumlahPaket"
                                            min="1"
                                            value="{{ old('JumlahPaket', $PekerjaanKurir->JumlahPaket ?? '') }}"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number"
                                            ...
                                            name="Durasi"
                                            min="1"
                                            value="{{ old('Durasi', $PekerjaanKurir->Durasi ?? '') }}"
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="Keterangan" name="Keterangan" class="d-none">{{ old('Keterangan', $PekerjaanKurir->Keterangan ?? '') }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                @enderror
                                <div id="BuktiFotoPreview" class="mt-2">
                                    @if(isset($PekerjaanKurir->BuktiFoto) && $PekerjaanKurir->BuktiFoto)
                                        <img src="{{ asset('storage/' . $PekerjaanKurir->BuktiFoto) }}" class="img-thumbnail" style="max-height:200px;">
                                    @endif
                                </div>
                            </div>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var InitialValue = `{!! old('Keterangan', $PekerjaanKurir->Keterangan ?? '') !!}`;
            if (InitialValue) {
