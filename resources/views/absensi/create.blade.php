...
@section('content')
    ...
    <div class="content-header pb-2">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 h3 fw-bold text-dark">Tambah Absensi</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}" class="text-decoration-none">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('absensi.index') }}"
                                class="text-decoration-none">Absensi</a></li>
                ...
                <div class="col-xl-12 col-lg-10 col-md-12">
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-white border-bottom-0 pt-4 pb-0">
                            <h5 class="mb-0 fw-bold text-primary"><i class="ti ti-clock-hour-9 me-2"></i>Form Tambah Absensi
                            </h5>
                        </div>
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('absensi.store') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            <label for="NamaDisplay" class="form-label fw-semibold">
                                                <i class="ti ti-user me-1 text-primary"></i> Nama <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <!-- Display Only -->
                                            <select class="form-select" id="NamaDisplay" disabled
                                        ...
                                        <div class="mb-4">
                                            <label for="Divisi" class="form-label fw-semibold">
                                                <i class="ti ti-building me-1 text-primary"></i> Divisi <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <select class="form-select @error('Divisi') is-invalid @enderror" id="Divisi"
                                                name="Divisi" required
                                                style="pointer-events: none; background-color: #e9ecef;">
                                                @foreach ($divisi as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ auth()->user()->divisi == $item->id ? 'selected' : '' }}>
                                                        {{ $item->Nama }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-4">
                                            <label for="NoHp" class="form-label fw-semibold">
                                                <i class="ti ti-phone me-1 text-primary"></i> No. HP <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <input type="text" class="form-control @error('NoHp') is-invalid @enderror"
                                                id="NoHp" name="NoHp"
                                                value="{{ old('NoHp', session('user_no_hp', auth()->user()->no_hp ?? '')) }}"
                                                placeholder="08xxxxxxxxxx" readonly required>
                                            @error('NoHp')
                                                <div class="invalid-feedback d-block error-fade-in">
                                                    <i class="ti ti-alert-circle me-1"></i>{{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            <label for="Tanggal" class="form-label fw-semibold"><i
                                                    class="ti ti-calendar me-1 text-primary"></i> Tanggal <span
                                        ...
                                        <div class="mb-4">
                                            <label for="Status" class="form-label fw-semibold"><i
                                                    class="ti ti-clipboard-check me-1 text-primary"></i> Status Kehadiran
                                                <span class="text-danger">*</span></label>
                                            <select class="form-select @error('Status') is-invalid @enderror" id="Status"
                                                name="Status" required>
                                                <option value="H" {{ old('Status', 'H') == 'H' ? 'selected' : '' }}>
                                                    Hadir (H)</option>
                                                <option value="I" {{ old('Status') == 'I' ? 'selected' : '' }}>Izin
                                                    (I)</option>
                                                <option value="S" {{ old('Status') == 'S' ? 'selected' : '' }}>Sakit
                                                    (S)</option>
                                                <option value="TK" {{ old('Status') == 'TK' ? 'selected' : '' }}>Tanpa
                                                    Keterangan (TK)</option>
                                            </select>
                                            @error('Status')
                                                <div class="invalid-feedback d-block error-fade-in"><i
                                                        class="ti ti-alert-circle me-1"></i>{{ $message }}</div>
                                        ...
                                        <div class="row">
                                            <div class="col-6 mb-4">
                                                <label for="JamHadir" class="form-label fw-semibold"><i
                                                        class="ti ti-login me-1 text-primary"></i> Jam Hadir</label>
                                                <input type="time"
                                                    class="form-control @error('JamHadir') is-invalid @enderror"
                                                    id="JamHadir" name="JamHadir" value="{{ old('JamHadir') }}">
                                                @error('JamHadir')
                                                    <div class="invalid-feedback d-block error-fade-in"><i
                                                            class="ti ti-alert-circle me-1"></i>{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-6 mb-4">
                                                <label for="JamPulang" class="form-label fw-semibold"><i
                                                        class="ti ti-logout me-1 text-primary"></i> Jam Pulang</label>
                                                <input type="time"
                                                    class="form-control @error('JamPulang') is-invalid @enderror"
                                                    id="JamPulang" name="JamPulang" value="{{ old('JamPulang') }}">
                                                @error('JamPulang')
                                                    <div class="invalid-feedback d-block error-fade-in"><i
                                                            class="ti ti-alert-circle me-1"></i>{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="mb-4">
                                            <label for="FotoAbsenMasuk" class="form-label fw-semibold">
                                                <i class="ti ti-camera me-1 text-primary"></i> Foto Absen Masuk <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <input type="file"
                                                class="form-control @error('FotoAbsenMasuk') is-invalid @enderror"
                                                id="FotoAbsenMasuk" name="FotoAbsenMasuk" accept="image/*" required>
                                            <div class="form-text text-warning mt-1 fw-semibold d-flex align-items-start">
                                                <i class="ti ti-alert-triangle me-1 mt-1"></i>
                                                <span>Foto wajib menggunakan <strong>GPS Map Camera</strong>, supaya
                                                    terlihat lokasi, tanggal, dan jam saat absensi.</span>
                                            </div>
                                            <div id="PreviewMasuk" class="mt-2 d-none">
                                                <img id="ImgPreviewMasuk" src="#" alt="Preview Masuk"
                                        ...
                                        <div class="mb-4">
                                            <label for="FotoAbsenKeluar" class="form-label fw-semibold">
                                                <i class="ti ti-camera-off me-1 text-primary"></i> Foto Absen Keluar
                                            </label>
                                            <input type="file"
                                                class="form-control @error('FotoAbsenKeluar') is-invalid @enderror"
                                                id="FotoAbsenKeluar" name="FotoAbsenKeluar" accept="image/*">
                                            <div class="form-text text-warning mt-1 fw-semibold d-flex align-items-start">
                                                <i class="ti ti-alert-triangle me-1 mt-1"></i>
                                                <span>Foto wajib menggunakan <strong>GPS Map Camera</strong>, supaya
                                                    terlihat lokasi, tanggal, dan jam saat absensi.</span>
                                            ...
                                            <div id="PreviewKeluar" class="mt-2 d-none">
                                                <img id="ImgPreviewKeluar" src="#" alt="Preview Keluar"
                                                    class="img-thumbnail shadow-sm"
                                                    style="max-height: 200px; max-width: 100%;">
                                            </div>
                                        ...
                                        <div class="mb-4">
                                            <label for="Lembur" class="form-label fw-semibold"><i
                                                    class="ti ti-hourglass me-1 text-primary"></i> Lembur? <span
                                                    class="text-danger">*</span></label>
                                            <select class="form-select @error('Lembur') is-invalid @enderror"
                                                id="Lembur" name="Lembur" required>
                                                <option value="N" {{ old('Lembur', 'N') == 'N' ? 'selected' : '' }}>
                                                    Tidak</option>
                                                <option value="Y" {{ old('Lembur') == 'Y' ? 'selected' : '' }}>Ya
                                                </option>
                                            </select>
                                            @error('Lembur')
                                                <div class="invalid-feedback d-block error-fade-in"><i
                                        ...
                                        <div id="LemburDetails" style="display: none;">
                                            <div class="row">
                                                <div class="col-6 mb-4">
                                                    <label for="MulaiLembur" class="form-label fw-semibold"><i
                                                            class="ti ti-play me-1 text-primary"></i> Mulai Lembur</label>
                                                    <input type="time"
                                                        class="form-control @error('MulaiLembur') is-invalid @enderror"
                                                        id="MulaiLembur" name="MulaiLembur"
                                                        value="{{ old('MulaiLembur') }}">
                                                    @error('MulaiLembur')
                                                        <div class="invalid-feedback d-block error-fade-in"><i
                                                                class="ti ti-alert-circle me-1"></i>{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="col-6 mb-4">
                                                    <label for="SelesaiLembur" class="form-label fw-semibold"><i
                                                            class="ti ti-stop me-1 text-primary"></i> Selesai
                                                        Lembur</label>
                                                    <input type="time"
                                                        class="form-control @error('SelesaiLembur') is-invalid @enderror"
                                                        id="SelesaiLembur" name="SelesaiLembur"
                                                        value="{{ old('SelesaiLembur') }}">
                                                    @error('SelesaiLembur')
                                                        <div class="invalid-feedback d-block error-fade-in"><i
                                                                class="ti ti-alert-circle me-1"></i>{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="mb-4">
                                                <label for="AlasanLembur" class="form-label fw-semibold">
                                                    <i class="ti ti-message-2 me-1 text-primary"></i> Alasan Lembur <span
                                                        class="text-danger">*</span>
                                                </label>
                                                <textarea class="form-control @error('AlasanLembur') is-invalid @enderror" id="AlasanLembur" name="AlasanLembur"
                                                    rows="2" placeholder="Jelaskan alasan lembur...">{{ old('AlasanLembur') }}</textarea>
                                                @error('AlasanLembur')
                                                    <div class="invalid-feedback d-block error-fade-in"><i
                                                            class="ti ti-alert-circle me-1"></i>{{ $message }}</div>
                                                @enderror
