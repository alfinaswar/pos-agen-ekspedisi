...
<div class="content-header pb-2">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6"><h1 class="m-0 h3 fw-bold text-dark">Tambah Absensi</h1></div>
            <div class="col-sm-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select @error('Status') is-invalid @enderror" id="Status" name="Status" required>
                                            <option value="H" {{ old('Status', 'H') == 'H' ? 'selected' : '' }}>Hadir (H)</option>
                                            <option value="I" {{ old('Status') == 'I' ? 'selected' : '' }}>Izin (I)</option>
                                            <option value="S" {{ old('Status') == 'S' ? 'selected' : '' }}>Sakit (S)</option>
                                            <option value="TK" {{ old('Status') == 'TK' ? 'selected' : '' }}>Tanpa Keterangan (TK)</option>
                                        </select>
                                    ...
                                    <div class="row">
                                        <div class="col-6 mb-4">
                                            ...
                                            <input type="time" class="form-control @error('JamHadir') is-invalid @enderror" id="JamHadir" name="JamHadir" value="{{ old('JamHadir') }}">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select @error('Lembur') is-invalid @enderror" id="Lembur" name="Lembur" required>
                                            <option value="N" {{ old('Lembur', 'N') == 'N' ? 'selected' : '' }}>Tidak</option>
                                            <option value="Y" {{ old('Lembur') == 'Y' ? 'selected' : '' }}>Ya</option>
                                        </select>
                                    ...
                                    <div id="LemburDetails" style="display: none;">
                                        <div class="row">
                                            <div class="col-6 mb-4">
                                                ...
                                                <input type="time" class="form-control @error('MulaiLembur') is-invalid @enderror" id="MulaiLembur" name="MulaiLembur" value="{{ old('MulaiLembur') }}">
                                            ...
                                            <div class="col-6 mb-4">
                                                ...
                                                <input type="time" class="form-control @error('SelesaiLembur') is-invalid @enderror" id="SelesaiLembur" name="SelesaiLembur" value="{{ old('SelesaiLembur') }}">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea class="form-control @error('AlasanLembur') is-invalid @enderror" id="AlasanLembur" name="AlasanLembur" rows="2" placeholder="Jelaskan alasan lembur...">{{ old('AlasanLembur') }}</textarea>
