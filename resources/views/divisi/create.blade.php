...
<div class="content-header pb-2">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6"><h1 class="m-0 h3 fw-bold text-dark">Tambah Divisi</h1></div>
            <div class="col-sm-6">
            ...
            <div class="col-xl-12 col-lg-10 col-md-12">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white border-bottom-0 pt-4 pb-0">
                        <h5 class="mb-0 fw-bold text-primary"><i class="ti ti-building me-2"></i>Form Tambah Divisi</h5>
                    </div>
                    <div class="card-body p-4">
                        <form action="{{ route('divisi.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control @error('Nama') is-invalid @enderror" id="Nama" name="Nama" value="{{ old('Nama') }}" placeholder="Contoh: IT, HRD, Keuangan" required autofocus>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('Keterangan') is-invalid @enderror" id="Keterangan" name="Keterangan" rows="3" placeholder="Deskripsi singkat tentang divisi ini...">{{ old('Keterangan') }}</textarea>
