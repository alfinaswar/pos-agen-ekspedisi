...
<head>
    ...
    <meta name="description"
        content="Maurekap membantu agen ekspedisi merekap pembayaran transfer & QRIS secara otomatis. Bukti tersimpan rapi, rekap harian cepat, monitoring real-time.">
    ...
    <style>
        ...
        * {
        ...
        header.scrolled {
            box-shadow: 0 6px 24px rgba(15, 27, 51, .09)
        }
        ...
        .hero {
            ...
            padding: clamp(52px, 7vw, 92px) 0 clamp(64px, 8vw, 110px);
            position: relative;
            overflow: hidden
        }
        ...
        .lap-screen {
            border: 9px solid #101828;
            border-bottom-width: 12px;
            border-radius: 14px 14px 0 0;
            overflow: hidden;
            background: #fff;
            box-shadow: 0 30px 60px -20px rgba(15, 27, 51, .3)
        }
        ...
        .dash {
            ...
            min-height: 30em;
            font-size: clamp(6.4px, 2px + 0.75vw, 10px)
        }
        ...
        .chart-line {
            ...
            animation: draw 2s .6s ease forwards
        }
        ...
        .lap-base {
            height: 13px;
            background: linear-gradient(#E8ECF2, #B9C2CF);
        ...
        .phone {
            ...
            border-radius: 26px;
            padding: 8px;
            box-shadow: 0 30px 60px -18px rgba(15, 27, 51, .45);
        ...
        .annot .draw {
            ...
            animation: draw 1.4s 1.4s ease forwards
        }
        ...
        .prob:hover {
            ...
            box-shadow: 0 16px 34px rgba(15, 27, 51, .1)
        }
        ...
        .step:hover {
            transform: translateY(-5px);
            box-shadow: 0 16px 36px rgba(15, 27, 51, .12)
        }
        ...
        .testi-wrap {
            background: var(--blue);
            border-radius: 26px;
            padding: clamp(44px, 6vw, 64px) clamp(20px, 4vw, 56px);
        ...
        .cta-card {
            ...
            border-radius: 22px;
            box-shadow: var(--shadow);
            padding: clamp(28px, 4.5vw, 48px) clamp(22px, 4vw, 52px);
            display: flex;
            align-items: center;
        ...
        .foot-grid {
            ...
            gap: 40px;
            padding: clamp(52px, 7vw, 76px) 0 46px
        }
        ...
        .socials a {
            ...
            height: 36px;
            border-radius: 50%;
            border: 1px solid rgba(159, 176, 201, .35);
            display: grid;
            place-items: center;
            transition: .2s
        }
        ...
        .foot-bottom {
            border-top: 1px solid rgba(159, 176, 201, .18);
            padding: 22px 0;
            text-align: center;
            font-size: .8rem
        }
        ...
        @media (max-width:920px) {
            ...
            .nav {
                ...
                box-shadow: -20px 0 50px rgba(15, 27, 51, .15);
                z-index: 65;
                overflow-y: auto
            }
        ...
        .wa-float {
            ...
            /* Menggunakan variabel hijau yang sudah ada */
            color: #fff;
            border-radius: 50%;
            display: flex;
            align-items: center;
        ...
        @media (max-width: 640px) {
            ...
            /* Sembunyikan tooltip di HP agar tidak mengganggu */
        }
...
<body>
        ...
        <div class="container head-in">
            ...
            <nav class="nav">
                ...
                <div class="nav-cta">
                    ...
                    <a href="{{ route('daftar') }}" class="btn btn-blue btn-sm">Daftar Sekarang</a>
                </div>
            </nav>
        </div>
    </header>
        ...
        <section class="hero">
            <div class="container hero-grid">
                <div class="hero-copy">
                    ...
                    <h1 data-rv style="--d:.08s">Punya Agen Multi Ekspedisi?<br>Rekap Pembayaran<br><span
                            class="acc">Jadi Mudah &amp; Rapi</span></h1>
                    <p class="hero-sub" data-rv style="--d:.16s"><b>Maurekap</b> adalah sistem rekap pembayaran untuk
                        pelaku usaha agen ekspedisi. Semua bukti pembayaran tersimpan rapi, mudah dicek, dan bisa
                        dimonitor kapan saja.</p>
                ...
                <div class="mock" data-rv style="--d:.2s">
                            ...
                            <div class="dash">
                                ...
                                <div class="dash-main">
                                    <div class="dash-stats">
                                        <div class="d-stat">
                                            <p class="lb">Total Transaksi</p>
                                            <p class="vl"><span class="count" data-count="1250">1.250</span></p>
                                            <p class="sb">Hari ini</p>
                                        </div>
                                        <div class="d-stat">
                                            <p class="lb">Total Masuk</p>
                                            <p class="vl blue">Rp <span class="count"
                                                    data-count="46678000">46.678.000</span></p>
                                            <p class="sb">Hari ini</p>
                                        </div>
                                        <div class="d-stat">
                                            <p class="lb">Belum Verifikasi</p>
                                            <p class="vl red"><span class="count" data-count="32">32</span></p>
                                            <p class="sb">Transaksi</p>
                                        </div>
                                    </div>
                                    <div class="d-chart">
                                        ...
                                        <svg viewBox="0 0 320 90" preserveAspectRatio="none" aria-hidden="true">
                                            <defs>
                                                <linearGradient id="gradB" x1="0" y1="0"
                                                    x2="0" y2="1">
                                                    <stop offset="0" stop-color="#2563EB" stop-opacity=".22" />
                                                    <stop offset="1" stop-color="#2563EB" stop-opacity="0" />
                                                </linearGradient>
                                            </defs>
                                            <g stroke="#EEF2F8" stroke-width="1">
                                                <line x1="0" y1="20" x2="320" y2="20" />
                                                <line x1="0" y1="45" x2="320" y2="45" />
                                                <line x1="0" y1="70" x2="320" y2="70" />
                                            </g>
                                            <path class="chart-area"
                                                d="M8,62 L52,50 L96,56 L140,34 L184,42 L228,20 L272,34 L312,26 L312,90 L8,90 Z" />
                                            <path class="chart-line"
                                                d="M8,62 L52,50 L96,56 L140,34 L184,42 L228,20 L272,34 L312,26" />
                                            <g>
                                                <circle class="chart-dot" cx="52" cy="50" r="3" />
                                                <circle class="chart-dot" cx="140" cy="34" r="3" />
                                                <circle class="chart-dot" cx="228" cy="20" r="3" />
                                                <circle class="chart-dot" cx="312" cy="26" r="3" />
                                            </g>
                                        </svg>
                                        <div class="d-x">
                                            <span>01/05</span><span>03/05</span><span>05/05</span><span>07/05</span>
                                        </div>
                                    </div>
                                    <div class="d-table">
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Dapur Mami</td>
                                                    <td>
                                                        <span style="font-weight:bold; color:#f36f21;">Lion
                                                            Parcel</span>
                                                    </td>
                                                    <td>QRIS</td>
                                                    <td>Rp 63.000</td>
                    ...
                    <div class="phone" aria-hidden="true">
                        <div class="phone-screen">
                            ...
                            <div class="ph-row">
                                <p class="lb">Dari</p>
                                <p class="vl">Rizky Rudy</p>
                            </div>
                            <div class="ph-row">
                                <p class="lb">Nominal</p>
                                <p class="vl big">QRIS · Rp 85.000</p>
                            </div>
                            <div class="ph-row">
                                <p class="lb">Waktu</p>
                                <p class="vl">12 Mei 2026 · 14:36</p>
                            </div>
                            <span class="ph-status">✓ Terverifikasi</span>
                            <div class="qr-box">
                                <svg viewBox="0 0 21 21" shape-rendering="crispEdges" fill="#0F172A"
                                    aria-hidden="true">
                                    <path d="M0 0h7v7H0z" />
                    ...
                    <div class="annot" aria-hidden="true">
                        ...
                        <svg viewBox="0 0 74 52">
                            <path class="draw" d="M6 46 C 26 44, 48 34, 62 12 M62 12 l-9 3 M62 12 l1 10" />
                        </svg>
                    </div>
                </div>
            </div>
        ...
        <section class="sec sec-alt" id="masalah">
            <div class="container">
                <div class="sec-head" data-rv>
                    ...
                    <p>Kelihatannya sepele, tapi terjadi hampir setiap hari. Jika dibiarkan, celah-celah kecil inilah
                        yang diam-diam menggerus waktu, tenaga, dan keuntungan usaha Anda.</p>
                </div>
                <div class="prob-grid">
                    <article class="prob" data-rv>
                        <div class="prob-ic" style="background:#E8F8EE;color:#16A34A"><svg viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                                <path d="M12 3a9 9 0 0 0-7.8 13.5L3 21l4.7-1.2A9 9 0 1 0 12 3z" />
                                <path
                                    d="M8.8 9.2c.4 2.6 3 5.2 5.6 5.6l1.4-1.4-2.2-1.2-1 .7c-.8-.4-1.7-1.3-2.1-2.1l.7-1z" />
                            </svg><span class="x">✕</span></div>
                        <p>Bukti pembayaran tercecer di WhatsApp</p>
                    </article>
                    <article class="prob" data-rv style="--d:.08s">
                        <div class="prob-ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                    ...
                    <article class="prob" data-rv style="--d:.24s">
                        <div class="prob-ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                ...
                                <path d="M16 14.7c2.8.2 4.9 2 5.5 4.8" />
                            </svg><span class="x">✕</span></div>
                        <p>Banyak admin, data tidak sinkron</p>
                    </article>
                    <article class="prob" data-rv style="--d:.32s">
                        <div class="prob-ic" style="background:#FFF6E6;color:#D97706"><svg viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                                <path d="M12 3L1.8 20.2h20.4z" />
                                <path d="M12 10v4.5" />
                                <circle cx="12" cy="17.6" r=".4" />
                            </svg><span class="x">✕</span></div>
        ...
        <section class="sec" id="manfaat">
            <div class="container">
                <div class="sec-head" data-rv>
                    ...
                    <p>Satu sistem yang membereskan semua masalah di atas — supaya Anda bisa fokus pada hal yang
                        benar-benar penting: mengembangkan usaha.</p>
                </div>
                <div class="ben-grid">
                    <article class="ben" data-rv>
                        <div class="ben-ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                    ...
                    <article class="ben" data-rv>
                        <div class="ben-ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                ...
                                <path d="M16 3.13V7h3.87" />
                                <path d="M16 3l5 5" />
                                <rect x="3" y="13" width="7" height="7" rx="1.5" />
                                <path d="M16 7a5 5 0 1 1-4.27 7.5" />
                            </svg></div>
                    ...
                    <article class="ben" data-rv style="--d:.06s">
                        <div class="ben-ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                ...
                                <path d="M12 7v-2a4 4 0 0 1 8 0v2" />
                            </svg></div>
        ...
        <section class="sec sec-alt" id="fitur-utama">
            <div class="container">
                ...
                <div class="feature-main-grid"
                    style="display: flex; gap: 28px; justify-content: center; align-items: stretch; margin-top: 28px; flex-wrap: wrap;">

                    <!-- Kartu 1: Absensi -->
                    <div class="main-feature-card"
                        style="background: #fff; border-radius: 15px; padding: 28px 20px 16px 20px; box-shadow: 0 2px 12px rgba(30,80,200,0.04); flex: 1; min-width: 240px; max-width310px; display: flex; flex-direction: column; align-items: flex-start;">
                        <div
                            style="background: #EFF6FF; border-radius: 50%; height: 45px; width: 45px; display: flex; align-items: center; justify-content: center; margin-bottom: 14px;">
                        ...
                        <div>
                            <div style="font-weight: 700; font-size: 1.05rem; margin-bottom: .3em; color: #0F172A;">
                                Absensi Karyawan</div>
                            <div style="font-size: .95rem; color: #475569; line-height: 1.5;" class="feature-desc">
                                Pantau kehadiran admin, finance, kurir, dan tim lapangan secara real-time. Riwayat
                                lengkap dan mudah diakses kapan saja.
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Kartu 2: Reimburse -->
                    <div class="main-feature-card"
                        style="background: #fff; border-radius: 15px; padding: 28px 20px 16px 20px; box-shadow: 0 2px 12px rgba(30,80,200,0.04); flex: 1; min-width: 240px; max-width: 310px; display: flex; flex-direction: column; align-items: flex-start;">
                        <div
                            style="background: #EFF6FF; border-radius: 50%; height: 45px; width: 45px; display: flex; align-items: center; justify-content: center; margin-bottom: 14px;">
                            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#2563eb"
                                stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                                <rect x="3" y="8" width="13" height="13" rx="2"></rect>
                                <path d="M16 18h6m-3-3v6"></path>
                                <path d="M8.5 13.5L9.5 16l2-2.5"></path>
                            </svg>
                        </div>
                        <div>
                            <div style="font-weight: 700; font-size: 1.05rem; margin-bottom: .3em; color: #0F172A;">
                                Reimburse & Rembes</div>
                            <div style="font-size: .95rem; color: #475569; line-height: 1.5;" class="feature-desc">
                                Ajukan dan kelola kebutuhan operasional (bensin, tol, makan) dengan alur persetujuan
                                yang jelas, transparan, dan tercatat rapi.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="main-feature-card"
                        ...
                        <div>
                            <div style="font-weight: 700; font-size: 1.05rem; margin-bottom: .3em; color: #0F172A;">
                                Laporan & Rekap Otomatis</div>
                            <div style="font-size: .95rem; color: #475569; line-height: 1.5;" class="feature-desc">
                                Dapatkan rekapitulasi keuangan harian, mingguan, dan bulanan secara instan. Ekspor data
                                ke Excel/PDF untuk laporan ke principal.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="main-feature-card"
                        ...
                        <div>
                            <div style="font-weight: 700; font-size: 1.05rem; margin-bottom: .3em; color: #0F172A;">
                                Manajemen Multi-Cabang</div>
                            <div style="font-size: .95rem; color: #475569; line-height: 1.5;" class="feature-desc">
                                Kelola operasional dari berbagai cabang atau outlet dalam satu dashboard terpusat.
                                Kontrol penuh tetap di tangan kantor pusat.
                            </div>
                        </div>
                    </div>
        ...
        <section class="sec sec-features" id="cara-kerja">
            <div class="container">
                <div class="sec-head" data-rv>
                    ...
                    <p>Tidak perlu paham teknologi. Jika tim Anda bisa memakai WhatsApp, mereka bisa memakai Maurekap —
                        empat langkah sederhana, sisanya berjalan otomatis.</p>
                </div>
                <div class="steps">
                    <article class="step" data-rv>
                        <div class="step-top"><span class="step-num">1</span>
                            <h3>Pembayaran dilakukan</h3>
                        </div>
                    ...
                    <div class="step-arrow" aria-hidden="true"><svg viewBox="0 0 30 16">
                            <path d="M0 8h24m0 0l-5-5m5 5l-5 5" />
                        </svg></div>
                    <article class="step" data-rv style="--d:.1s">
                        <div class="step-top"><span class="step-num">2</span>
                            <h3>Upload bukti pembayaran</h3>
                        </div>
                        <p>Admin upload bukti pembayaran di Maurekap.</p>
                        <div class="step-ill"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M7 18a5 5 0 0 1-.8-9.9 6 6 0 0 1 11.6 0A5 5 0 0 1 17 18" />
                                <path d="M12 21v-8" />
                                <path d="M8.5 16l3.5-3.5L15.5 16" />
                            </svg></div>
                    </article>
                    <div class="step-arrow" aria-hidden="true"><svg viewBox="0 0 30 16">
                            <path d="M0 8h24m0 0l-5-5m5 5l-5 5" />
                    ...
                    <article class="step" data-rv style="--d:.2s">
                        <div class="step-top"><span class="step-num">3</span>
                            <h3>Data otomatis tersimpan</h3>
                        </div>
                        <p>Maurekap menyimpan nominal, seller, bukti, dan waktu transaksi.</p>
                        <div class="step-ill"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
                                <ellipse cx="11" cy="5.5" rx="8" ry="3" />
                                <path d="M3 5.5v6c0 1.7 3.6 3 8 3s8-1.3 8-3v-6" />
                                <path d="M3 11.5v6c0 1.7 3.6 3 8 3s8-1.3 8-3v-6" />
                                <circle cx="19.5" cy="17.5" r="3.4" fill="#fff" />
                                <path d="M18 17.5l1.2 1.2 2-2.4" />
                            </svg></div>
                    </article>
                    <div class="step-arrow" aria-hidden="true"><svg viewBox="0 0 30 16">
                            <path d="M0 8h24m0 0l-5-5m5 5l-5 5" />
                    ...
                    <article class="step" data-rv style="--d:.3s">
                        <div class="step-top"><span class="step-num">4</span>
                            <h3>Owner monitoring</h3>
                        </div>
                        ...
                        <div class="step-ill"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                ...
                                <path d="M6.5 13l3-3.5 2.5 2 4-5 1.5 2" />
                            </svg></div>
                    </article>
                </div>
            </div>
  ...
  <div class="container">
            ...
            <div class="container">
                <div class="cta-card" data-rv>
                    <div class="cta-ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            ...
                            <path
                                d="M12 15l-3-3a22 22 0 0 1 2-3.9A12.8 12.8 0 0 1 21.5 2.5 12.8 12.8 0 0 1 15.9 13a22 22 0 0 1-3.9 2z" />
                            <path d="M9 12H4s.5-3 2-4c1.6-1 5 0 5 0" />
                            <path d="M12 15v5s3-.5 4-2c1-1.6 0-5 0-5" />
                            <circle cx="15.5" cy="8.5" r="1.8" />
                        </svg></div>
                    <div class="cta-txt">
                        <span class="sec-tag">Mulai Sekarang</span>
                        <h2>Kelola Pembayaran Jadi Lebih Mudah</h2>
                        <p>Fokus kembangkan usaha, biar Maurekap yang urus rekapnya. Rasakan sendiri kemudahannya untuk
                            bisnis Anda.</p>
                    </div>
                    <div class="cta-right">
    ...
    <a href="https://wa.me/6285143671253?text=Halo%20Maurekap,%20saya%20tertarik%20dengan%20sistem%20rekap%20pembayaran%20ini.%20Boleh%20minta%20info%20lebih%20lanjut?"
        class="wa-float" target="_blank" rel="noopener noreferrer" aria-label="Chat dengan kami via WhatsApp">
        ...
        <div class="container">
            <div class="foot-grid">
                <div class="foot-brand">
                    <a class="logo d-flex align-items-center" href="#beranda"
                    ...
                    <p>Sistem rekap pembayaran untuk agen ekspedisi. Bantu usaha Anda lebih rapi, cepat, dan terkontrol.
                    </p>
                    <div class="socials">
                        ...
                        <a href="https://www.instagram.com/maurekap" aria-label="Instagram"><svg viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                        ...
                        <a href="#" aria-label="X / Twitter"><svg viewBox="0 0 24 24" fill="none"
                ...
                <div>
                    ...
                    <ul class="contact">
                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path d="M12 3a9 9 0 0 0-7.8 13.5L3 21l4.7-1.2A9 9 0 1 0 12 3z" />
                            </svg><span>WhatsApp<br>0851-4367-1253</span></li>

                        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round">
                                <rect x="3" y="5" width="18" height="14" rx="2" />
                                <path d="M3 7l9 6 9-6" />
                            </svg><span>Email<br>support@maurekap.com</span></li>
                    </ul>
                </div>
            </div>
