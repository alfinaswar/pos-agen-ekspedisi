...
<div class="content-header pb-2">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 h3 fw-bold text-dark">Tambah Pengumuman</h1>
            </div>
            <div class="col-sm-6">
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white border-bottom-0 pt-4 pb-0">
                        <h5 class="mb-0 fw-bold text-primary">
                            <i class="ti ti-megaphone me-2"></i>Form Tambah Pengumuman
                        </h5>
                    </div>

                    <div class="card-body p-4">
                        <!-- ✅ TAMBAHKAN enctype="multipart/form-data" DI SINI -->
                        <form action="{{ route('pengumuman.store') }}" method="POST" enctype="multipart/form-data" id="FormPengumuman">
                            @csrf
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="Isi" name="Isi" class="d-none">{{ old('Isi') }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <!-- Area Pratinjau Gambar (Hidden by default) -->
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var InitialValue = `{!! old('Isi', '') !!}`;
            if (InitialValue) {
                QuillInstance.root.innerHTML = InitialValue;
                IsiField.value = InitialValue;
            }

            // 3. ✅ LOGIKA UPLOAD & PREVIEW GAMBAR (Pascal Case Variables)
