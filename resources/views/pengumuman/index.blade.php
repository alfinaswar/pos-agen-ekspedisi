                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered dt-responsive nowrap align-middle mb-0"
                                id="pengumumanTable" style="width: 100%;">
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.btn-delete', function() {
                ...
                Swal.fire({
                    ...
                    html: `Anda akan menghapus pengumuman:<br><strong class="text-primary">${Judul}</strong><br>Tindakan ini tidak dapat dibatalkan!`,
                    icon: 'warning',
                        ...
                        $.ajax({
                            ...
                            success: function(Response) {
                                if (Response.status === 200 || Response.success) {
                                    ...
                                    $('#pengumumanTable').DataTable().ajax.reload(null, false);
                                } else {
