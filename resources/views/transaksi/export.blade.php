<table>
    ...
    {{-- Baris 2: Spasi --}}
    <tr><td colspan="9" style="height: 7px;"></td></tr>
    ...
    <tr>
        <td colspan="9" style="text-align: left; color: #444; padding: 5px; font-style:italic;">
    ...
    <tr style="background-color: #E7F1FF; font-weight: bold; color: #0D6EFD;">
        <td colspan="7" style="padding: 8px; border: 1px solid #DEE2E6; text-align: right;">Total Pendapatan</td>
        <td colspan="2" style="padding: 8px; border: 1px solid #DEE2E6; text-align: right;">
