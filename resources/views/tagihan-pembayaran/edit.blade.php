            ...
            <div class="col-xl-10 col-lg-12 col-md-12">
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('tagihan-pembayaran.update', $TagihanPembayaran->id) }}" method="POST" id="FormTagihan">
                            @csrf
                            @method('PUT')
                            <div class="row g-4">
                                <!-- Kolom Kiri -->
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control @error('PeriodeBulan') is-invalid @enderror" id="PeriodeBulan" name="PeriodeBulan" value="{{ old('PeriodeBulan', $TagihanPembayaran->PeriodeBulan) }}" required>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="date" class="form-control @error('TanggalJatuhTempo') is-invalid @enderror" id="TanggalJatuhTempo" name="TanggalJatuhTempo" value="{{ old('TanggalJatuhTempo', $TagihanPembayaran->TanggalJatuhTempo->format('Y-m-d')) }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control text-end @error('JumlahTagihan') is-invalid @enderror" id="JumlahTagihan" name="JumlahTagihan" value="{{ old('JumlahTagihan', number_format($TagihanPembayaran->JumlahTagihan, 0, ',', '.')) }}" required>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control @error('Catatan') is-invalid @enderror" id="Catatan" name="Catatan" rows="4">{{ old('Catatan', $TagihanPembayaran->Catatan) }}</textarea>
